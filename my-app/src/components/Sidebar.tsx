...
export function Sidebar() {
    ...
    const closeSidebar = side?.closeSidebar ?? (()=>{});
        ...
        <div className={`mobileSidebar ${sidebarOpen ? 'open' : ''}`}>
            <li className="nav-links">
                <ul>
                    ...
                    <li><Link to="#mobile-app" onClick={() => closeSidebar()}>{t("navigation_mobile_app")}</Link></li>
            ...
            <ul className="modPanel">
                ...
                {
                    <Link to={"/cart"} className="cartDisplay" onClick={() => closeSidebar()}>
                ...
                <li className="nav-menu">
                    <Link to="/menu" onClick={() => closeSidebar()}>{t("navigation_menu")}</Link>
